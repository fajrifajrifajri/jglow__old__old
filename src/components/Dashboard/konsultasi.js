...
import { TableKonsultasi } from './Konsultasi/table-konsultasi';
			...
			<div className="bg-white min-h-screen rounded-tl-lg ml-12 p-12">
				<div className="grid grid-cols-12 mb-8">
					...
					<div className="col-span-6 flex gap-x-1">
						<button className="flex-1 bg-yellow-400 p-2 bkonsultasi bkonsultasi-black">30 MENUNGGU</button>
						<button className="flex-1 bg-green-400 p-2 bkonsultasi bkonsultasi-black">24 KONSULTASI</button>
						<button className="flex-1 bg-red-400 p-2 bkonsultasi bkonsultasi-black">4 CANCELLED</button>
					</div>
				</div>
				<TableKonsultasi/>
			</div>
